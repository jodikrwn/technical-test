        ...
        @forelse ($designations as $designation)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        <div
                            class="h-2.5 w-2.5 rounded-full {{ $designation->is_active ? 'bg-green-500' : 'bg-red-500' }} me-2">
                        </div> {{ $designation->is_active ? 'Active' : 'Inactive' }}
                    </div>
                </td>
                <td class="px-6 py-4">
                    <button
                        ...
                        >
                            ...
                            <li>
                                <form
                                    ...
                                    data-url="{{ route('designation.destroy', ['designation' => $designation]) }}"
                                >
                                    @csrf
                                    @method('DELETE')
                                    <button
                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form
                                    ...
                                    data-url="{{ route('designation.update', ['designation' => $designation]) }}"
                                >
                                    @csrf
                                    @method('PUT')
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2 sm:col-span-1">
                                            ...
                                            >
                                                <option
                                                    value="1"
                                                    {{ $designation->is_active ? 'selected' : '' }}
                                                >Active</option>
                                                <option
                                                    value="0"
                                                    {{ !$designation->is_active ? 'selected' : '' }}
